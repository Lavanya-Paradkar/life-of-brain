export const quizData = [
    ...
    // },
    {
        ...
        answers: [
          ...
          {
            text: "I don't enjoy things the way I used to",
            value: 1,
          },
          {
          ...
          {
            text: "I am dissatisfied or bored with everything",
            value: 3,
          },
        ],
      },
      ...
      // },
      {
        ...
        answers: [
          ...
          {
            text: "I blame myself all the time for my faults",
            value: 2,
          },
          {
            text: "I am disappointed in myself",
      ...
      // },
      {
        ...
        answers: [
          ...
          {
            text: "I cry more now than I used to",
            value: 1,
          },
          {
            text: "I cry all the time now",
            value: 2,
          },
          {
            text: "I used to cry, but now I can't cry even though I want to",
            value: 3,
          },
        ],
      },
      {
        ...
        answers: [
          ...
          {
            text: "I am slightly more irritated now than usual",
            value: 1,
          },
          {
          ...
          {
            text: "I feel irritated all the time",
            value: 3,
          },
        ],
      },
      {
        ...
        answers: [
          ...
          {
            text: "I have lost all of my interest in other people",
            value: 3,
          },
        ],
      },
      {
        ...
        answers: [
          ...
          {
            text: "I hesitate in making decisions more than I used to",
            value: 1,
          },
          {
          ...
          {
            text: "I can't make decisions at all anymore",
            value: 3,
          },
        ],
      },
      {
        ...
        answers: [
          ...
          {
            text: "I feel there are changes in my appearance that make me look unattractive",
            value: 2,
          },
          {
            text: "I feel that people don't like me anymore",
            value: 3,
          },
        ],
      },
      ...
      // },
      {
        ...
        answers: [
          ...
          {
            text: "I get tired more easily than I used to",
            value: 1,
          },
          {
            text: "I get tired from doing almost anything",
            value: 2,
          },
          {
            text: "I am too tired to do anything",
            value: 3,
          },
        ],
      },
